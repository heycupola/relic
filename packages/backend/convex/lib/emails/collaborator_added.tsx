      ...
      <Container style={container}>
        <Section style={section}>
          ...
          <Text style={paragraph}>
            <strong style={bold}>{ownerName}</strong> added you as a collaborator on{" "}
            <strong style={bold}>{projectName}</strong>.
          </Text>
          <Text style={paragraph}>
          ...
          <Section style={block}>
            ...
            <Text style={listItemLast}>Manage project structure</Text>
          </Section>
          <Section style={infoBlock}>
            <Text style={infoText}>
              Access is controlled by the project owner and can be revoked at any time.
            </Text>
          </Section>
