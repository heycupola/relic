...
- _"What secrets are in my production environment?"_
- _"List all my Relic projects"_
- _"Run my test suite with staging secrets"_
- _"Which project is this directory linked to?"_
