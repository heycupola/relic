...
The Relic CLI handles authentication, project initialization, and secret injection. For interactive secret management, use the [TUI](/guides/tui).
...
<Info>
  Add `.relic/` to your `.gitignore`. See [Introduction](/introduction#initialize-your-project) for details.
</Info>
